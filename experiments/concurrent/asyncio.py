...
class Novel:
    ...
    async def getChapter(self, chapter):
    ...
    #   return tuple({
    #     # "chapterList": "<item media-type=\"application/xhtml+xml\" href=\"" + str(chapter) + ".xhtml""\" id=\"_" + str(chapter) + ".xhtml\" />",
    #     # "chapterListAgain": "<itemref idref=\"_" + str(chapter) + ".xhtml\" />"
        
    #     "chapterList": f'<item media-type="application/xhtml+xml" href="{chapter}.xhtml" id="_{chapter}.xhtml" />',
    #     "chapterListAgain": f'<itemref idref="_{chapter}.xhtml" />'
    #   })

    async def genBook(self):
        ...
        tasks = [self.getChapter(i+1) for i in range(self.chapterCount) ]
